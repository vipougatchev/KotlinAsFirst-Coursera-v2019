 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg * 3600 + min * 60 + sec).toDouble() / 3600.0 * PI / 180.0
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial.toDouble() * (1.0 + percent.toDouble() / 100) *
        (1.0 + percent.toDouble() / 100) * (1.0 + percent.toDouble() / 100)
